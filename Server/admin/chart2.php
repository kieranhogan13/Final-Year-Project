  ...
  <body>
      ...
      <div class="container">
        ...
        <div id="navbar" class="collapse navbar-collapse">
          <ul class="nav navbar-nav">
            ...
            <li class="active"><a href="#">Chart 2</a></li>
    ...
    <div class="container">
      ...
      <div class="starter-template">
        <h1>Time spent playing all activities</h1>
        <div id="p1" >
...
if(empty($_SESSION['login_admin']))
{
  ...
  */
  ...
  $strQuery = "SELECT levelname, timeplayed FROM tracking ORDER BY levelname";
  ...
  $arrData = array(
    "chart" => array
    (
      "caption" => "Time playing each activity (seconds)",
      "paletteColors" => "#00e6e6",
      "bgColor" => "#ffffff",
      "borderAlpha"=> "20",
      "canvasBorderAlpha"=> "0",
